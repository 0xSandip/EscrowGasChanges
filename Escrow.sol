...
contract Escrow is IEscrow, ReentrancyGuard {
    ...
    uint256 public constant CONFIRMED = 2;
    uint256 public constant DISPUTED = 3;
    uint256 public constant RESOLVED = 4;
    ...
    /// @inheritdoc IEscrow
    function confirmReceipt() external onlyBuyer inState(CREATED) {
        s_state = CONFIRMED;
    ...
    /// @inheritdoc IEscrow
    function initiateDispute() external onlyBuyerOrSeller inState(CREATED) {
    ...
    /// @inheritdoc IEscrow
    function resolveDispute(uint256 buyerAward) external onlyArbiter nonReentrant inState(DISPUTED) {
